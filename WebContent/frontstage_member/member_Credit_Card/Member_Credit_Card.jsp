...
.form-container {
    ...
    grid-template-areas: "name name""number number""expiration security""zip a""address address";
    max-width: 400px;
    padding: 20px;
    color: #707070;
}
...
button.btn_filter:hover{
  background-color: #556FFF;
}

button.btn_filter.-on{
  width: 100px;
  margin: 5px;
...
<body>
 <div class="payment-title">
    ...
    <form method="post" action="<c:url value="/credit_card/Credit_Card.Controller" />" >
    <div class="form-container">
        <div class="field-container">
            <label for="name">Name</label>
            <input name="ownername" id="name" maxlength="20" type="text" value="${card.credit_Card_Owner_Name }">
        </div>
        <div class="field-container">
            <label for="cardnumber">Card Number</label><span id="generatecard">generate random</span>
            <input name="cardnumber" id="cardnumber" type="text" value="${card.credit_Card_Number }">
        ...
        <div class="field-container">
            ...
            <input name="expiredate" id="expirationdate" type="text" value="${card.credit_Card_Expire_M } / ${card.credit_Card_Expire_Y }">
        </div>
        <div class="field-container">
        ...
        <div class="field-container">
            ...
            <input name="address" id="address" type="text" value="${card.credit_Card_Address }">
        </div>
        <div class="field-container">
            <label for="zip">zip</label>
            <input name="zip" id="zip" type="text" value="${card.credit_Card_Postal_Code }" >
            <input type="hidden" name="state" value="1">
        </div>
    </div>
        <button class="btn_filter" type="submit" name="action" value="insertCreditCard">確認 </button>
    </form>
