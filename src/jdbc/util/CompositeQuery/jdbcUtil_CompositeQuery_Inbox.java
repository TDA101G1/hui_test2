...
public class jdbcUtil_CompositeQuery_Inbox {

	public static String get_aCondition_For_Oracle(String columnName, String value) {

		String aCondition = null;

		if ("EMP_ID".equals(columnName) || "INBOX_MAIL_TITLE".equals(columnName)) // �Ω�varchar
			aCondition = columnName + " like '%" + value + "%'";
		else if ("INBOX_MAIL_TIMESTAMP".equals(columnName))                          // �Ω�Oracle��date
	...
	public static void main(String argv[]) {
		...
		String finalSQL = "select * from emp2 "
				          + jdbcUtil_CompositeQuery_Inbox.get_WhereCondition(map)
				          + "order by empno";
