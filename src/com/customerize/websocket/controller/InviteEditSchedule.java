...
//				message.setText("Dear Levin, \n\n <a herf=#/> \\n 1231231321321測試 測試 測試 測試 測試 測試 email !", "text/html");// 信件內容
				message.setContent("<h1>台灣第一旅遊網站 - Tourism</h1>"
								+ "<a href='" + req.getServerName() + req.getContextPath() +"/CustomerizeController?action=produce_schedule&cust_schedule_id="+cust_schedule_id+"'>立即前往編輯行程</a>", "text/html; charset=UTF-8" );
