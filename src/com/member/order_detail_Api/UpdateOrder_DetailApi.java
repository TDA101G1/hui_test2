...
public class UpdateOrder_DetailApi extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Integer use_qty = Integer.parseInt(request.getParameter("use_qty"));
					...
					if (bean.getOrder_Detail_Used_Qty() >= bean.getOrder_Detail_Qty()) {
						...
						if (use_qty > (bean.getOrder_Detail_Qty() - bean.getOrder_Detail_Used_Qty())) {
							...
							if (update_Num.equals(1)) {
								out.print("成功");
								out.print("reason" + "已成功使用:" + use_qty + " 目前還剩餘:"
										+ (bean.getOrder_Detail_Qty() - bean.getOrder_Detail_Used_Qty()));
								out.close();
							}
						}
					}
...
//								if (update_Num.equals(1)) {
//									ob.put("result", true);
//									ob.put("reason", "已成功使用:" + use_qty + " 目前還剩餘:"
//											+ (bean.getOrder_Detail_Qty() - bean.getOrder_Detail_Used_Qty()));
